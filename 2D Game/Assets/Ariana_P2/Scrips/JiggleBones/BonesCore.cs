...
{
#if UNITY_5
	[Tooltip("Root of the transform hierarchy to apply physics.")]
#endif
    public Transform m_Root = null;

#if UNITY_5
	[Tooltip("Physics simulation rate (Internal)")]
#endif
...
#if UNITY_5
	[Tooltip("Force applied to return each bone to original orientation.")]
#endif
    [Range(0, 1)]
...
#if UNITY_5
	[Tooltip("Bone's original orientation are preserved.")]
#endif
    [Range(0, 1)]
...
#if UNITY_5
	[Tooltip("Character's position change is ignored in physics simulation.")]
#endif
    [Range(0, 1)]
...
#if UNITY_5
	[Tooltip("Each bone can be a sphere to collide with colliders. Radius describes sphere's size.")]
#endif
...
#endif
    public List<BonesColBase> m_Colliders = null;
